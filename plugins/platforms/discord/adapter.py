...
#
# Detection logic lives in the shared module so Telegram (and future adapters)
# stay in sync without copy-paste drift.
from gateway.platforms.auto_choice_utils import (  # noqa: E402
